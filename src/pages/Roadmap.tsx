    ...
    const phases = [
        {
            ...
            status: "In Progress",
            items: [
                "Establish core partnerships with 50 pilot schools.",
        ...
        },
        {
            ...
            status: "Planning",
            items: [
                "Targeting 15,000 students for scholarship eligibility.",
                "Expanding vocational evening hubs to 20 locations.",
        ...
        },
        {
            ...
            items: [
                "Establishing Enako presence in 12 African nations.",
                "Digital Equity project: 1,000+ computer labs.",
            ...
            <main className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
                <FadeIn direction="up">
                    <div className="max-w-3xl mb-24">
                        <span className="text-primary font-black tracking-[0.4em] uppercase text-[10px] block mb-6">Strategic Vision</span>
                        <h1 className="text-navy text-5xl md:text-8xl font-black leading-[0.9] tracking-tighter mb-8">
                            Innovation <br />
                                ...
                                <div className="flex flex-col lg:flex-row gap-12 items-start relative z-10">
                                    ...
                                    <div className="flex-grow space-y-8">
                                        <div className="space-y-2">
                                            ...
                                            <h3 className="text-4xl font-black text-navy tracking-tight italic">{phase.title}</h3>
                                        </div>
                ...
                <div className="mt-32 p-16 rounded-[4rem] bg-navy relative overflow-hidden text-center">
                    ...
                    <FadeIn direction="up">
                        <h2 className="text-white text-4xl md:text-6xl font-black tracking-tighter mb-8 relative z-10">
                            Ready to be part of the <span className="text-primary italic">Future?</span>
                        </h2>
                        <button className="relative z-10 px-12 py-6 bg-primary text-white font-black text-xs uppercase tracking-widest rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-primary/40">
                            Partner for Scale
                        </button>
                    </FadeIn>
                </div>
