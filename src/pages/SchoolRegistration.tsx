        ...
        <div className="flex flex-col min-h-screen bg-background-light">
            ...
            <main className="flex-grow">
                ...
                <section className="relative w-full min-h-[60vh] flex flex-col lg:flex-row overflow-hidden">
                    <div className="lg:w-1/2 pt-40 pb-16 px-6 lg:px-20 flex flex-col justify-center bg-white w-full">
                        <FadeIn direction="right">
                            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-primary border border-primary text-primary text-xs font-bold uppercase tracking-widest w-fit mb-6">
                                <span className="material-symbols-outlined text-sm">school</span>
                                School Registration
                            </span>
                            <h1 className="text-navy text-4xl md:text-5xl font-black leading-tight tracking-tight mb-6">
                                Register Your School's<br /><span className="text-primary">Top Students</span>
                            </h1>
                            ...
                            <div className="flex gap-4">
                                <a href="#form" className="flex items-center justify-center gap-2 h-12 px-6 bg-primary rounded-lg text-white font-bold hover:bg-primary transition-all">
                    ...
                    <div className="max-w-7xl mx-auto">
                        <FadeIn direction="up">
                            <div className="text-center mb-12">
                                <span className="text-primary font-bold tracking-widest uppercase text-xs block mb-2">Criteria</span>
                ...
                <section className="py-16 px-6 lg:px-20 bg-background-light">
                    <div className="max-w-5xl mx-auto">
                        <FadeIn direction="up">
                            <div className="text-center mb-12">
                                <span className="text-primary font-bold tracking-widest uppercase text-xs block mb-2">How It Works</span>
                            ...
                            {steps.map((s, i) => (
                                <FadeIn key={s.title} direction="up" delay={i * 0.3}>
                                    <div className="relative flex flex-col items-center text-center group">
                                        ...
                                        <div className="relative z-10 w-12 h-12 bg-white border-2 border-primary rounded-full flex items-center justify-center text-primary mb-4 transition-transform group-hover:scale-110 duration-300">
                                            <span className="material-symbols-outlined text-xl">{s.icon}</span>
                                        </div>
                                        <div className="text-primary text-xs font-bold uppercase tracking-widest mb-1">Step {i + 1}</div>
                ...
                {/* REGISTRATION FORM */}
                <section className="py-16 px-6 lg:px-20 bg-white" id="form">
                    <div className="max-w-3xl mx-auto">
                        <FadeIn direction="up">
                            <div className="text-center mb-10">
                                <span className="text-primary font-bold tracking-widest uppercase text-xs block mb-2">Application</span>
                        ...
                        <FadeIn direction="up" delay={0.2}>
                            <div className="bg-background-light rounded-2xl border border-slate-200 p-8 md:p-12 shadow-xl">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        ...
                                        <input type="text" value={form.schoolName} onChange={(e) => setForm({ ...form, schoolName: e.target.value })}
                                            className="w-full h-12 px-4 border-2 border-slate-200 rounded-lg focus:outline-none focus:border-primary text-navy bg-white"
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:border-primary transition-colors cursor-pointer">
                ...
                <section className="py-20 px-6 bg-navy text-center">
                    <FadeIn direction="up">
                        ...
                        <div className="flex gap-4 justify-center">
                            <Link to="/volunteer" className="inline-flex items-center gap-2 h-12 px-8 bg-primary rounded-lg text-white font-bold hover:bg-primary transition-all">
