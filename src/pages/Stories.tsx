    ...
    return (
        <div className="flex flex-col min-h-screen bg-background-light">
            ...
            <main className="flex-grow">
                ...
                <section className="relative w-full min-h-[75vh] flex flex-col overflow-hidden bg-navy">
                    ...
                    <div className="relative z-20 flex-1 flex flex-col justify-end max-w-7xl mx-auto px-6 lg:px-20 w-full pb-20 pt-40">
                        <FadeIn direction="up">
                            ...
                            <h1 className="text-white text-6xl md:text-8xl font-black leading-[0.9] tracking-tighter mb-8 max-w-4xl">
                                Voices of <br />
                ...
                {/* FEATURED STORY */}
                <section className="py-24 px-6 lg:px-20 bg-white" id="stories">
