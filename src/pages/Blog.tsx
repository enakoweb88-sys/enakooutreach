        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="relative">
                ...
                <main className="flex-grow pt-32 pb-24 relative z-10">
                    ...
                    {/* FILTERS */}
                    <section className="container mx-auto px-6 mb-16 bg-transparent">
                        <div className="flex flex-col md:flex-row gap-8 items-center justify-between p-8 rounded-[2.5rem] bg-white/80 backdrop-blur-md border border-slate-100 shadow-premium">
