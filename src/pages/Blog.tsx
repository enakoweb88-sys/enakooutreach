...
import { Calendar, User, ArrowRight, Search, BookOpen, Rss, Archive } from 'lucide-react';
        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="relative">
                ...
                <main className="flex-grow relative z-10">
                    {/* HERO */}
                    <section className="pt-40 pb-20 bg-gradient-to-br from-slate-900 to-green-950 relative overflow-hidden">
                        <div className="absolute inset-0 opacity-5"
                            style={{ backgroundImage: 'radial-gradient(circle, #22c55e 1px, transparent 1px)', backgroundSize: '36px 36px' }} />
                        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                            <FadeIn direction="up">
                                <span className="text-green-400 font-bold tracking-[0.4em] uppercase text-xs block mb-4">Enako Insights</span>
                                <h1 className="text-white text-5xl md:text-6xl font-black leading-tight mb-6">
                                    Stories from
                                    <span className="block text-green-400">Cameroon</span>
                                </h1>
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {[
                                        ...
                                        <Link key={item.label} to={item.to}
                                            className="flex items-center gap-2 px-5 py-2.5 bg-white/10 border border-white/20 text-white text-sm font-semibold rounded-xl hover:bg-green-600 hover:border-green-600 transition-all backdrop-blur-sm">
