                            ...
                            <FadeIn direction="right">
                                ...
                                <div className="flex items-center gap-6 pt-10 border-t border-white/10">
                                    <div className="flex -space-x-3">
                                        ...
                                        <div className="w-12 h-12 rounded-full border-4 border-navy bg-primary flex items-center justify-center text-white text-[10px] font-black ">
                                            +2k
                                        </div>
                                    </div>
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="flex flex-col items-center text-center mb-20">
                                ...
                                <h2 className="text-navy text-4xl md:text-6xl font-black tracking-tighter leading-none mb-8">
                                    Where We <span className="text-primary ">Need You.</span>
                                </h2>
