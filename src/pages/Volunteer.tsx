    ...
    return (
        <div className="flex flex-col min-h-screen bg-background-light">
            ...
            <main className="flex-grow">
                    ...
                    <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-20 w-full pt-32 pb-16">
                        <FadeIn direction="right">
                            ...
                            <div className="flex flex-wrap gap-6 mb-16">
                                <a href="#apply" className="group relative flex items-center justify-center overflow-hidden rounded-xl bg-primary px-10 h-16 text-white font-black transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-primary/40">
                                    Start Volunteering
                                </a>
                            ...
                            <div className="flex items-center gap-6 pt-10 border-t border-white/10">
                                <div className="flex -space-x-3">
                                    ...
                                    <div className="w-12 h-12 rounded-full border-4 border-navy bg-primary flex items-center justify-center text-white text-[10px] font-black italic">
                                        +2k
                                    </div>
                                </div>
                                <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.2em]">Join 2,400+ changemakers worldwide</p>
                            </div>
                        </FadeIn>
                    </div>
                </section>
                ...
                {/* BREADCRUMB */}
                <section className="bg-white border-b border-slate-100 py-10 px-6 lg:px-20">
                            ...
                            {[
                                ...
                                <FadeIn key={role.title} delay={i * 0.1} direction="up" fullWidth>
                                    <div className="bg-white p-10 rounded-[3rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] hover:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.08)] transition-all duration-500 group border border-slate-100/50 h-full flex flex-col">
                                        ...
                                        <div className="mt-8 pt-8 border-t border-slate-50 flex items-center gap-2 text-primary text-[10px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                {/* APPLICATION FORM */}
                <section className="py-32 px-6 lg:px-20 bg-slate-50" id="apply">
                            ...
                            <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div className="space-y-4">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-16 px-8 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-primary/20 transition-all text-navy font-bold"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <select
                                            ...
                                            className="w-full h-16 px-8 bg-slate-50 rounded-2xl border-none focus:ring-2 focus:ring-primary/20 transition-all text-navy font-bold appearance-none"
                                        >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <textarea
                                        ...
                                        rows={5}
                                        className="w-full p-8 bg-slate-50 rounded-3xl border-none focus:ring-2 focus:ring-primary/20 transition-all text-navy font-bold resize-none"
                                        placeholder="Tell us why you'd like to join our community..."
                                    />
                                </div>
                                <button
                                    type="submit"
                                    className="w-full h-20 bg-navy rounded-2xl text-white font-black text-xs uppercase tracking-[0.2em] hover:bg-primary transition-all shadow-2xl shadow-navy/20 flex items-center justify-center gap-4 group"
                                >
                                    Submit Application <Send className="w-4 h-4 group-hover:translate-x-2 transition-transform" />
                                </button>
                                <div className="flex items-center justify-center gap-4 text-slate-400 text-[10px] font-black uppercase tracking-widest italic">
                                    <CheckCircle2 className="w-3 h-3 text-primary" /> Verified Secure Application
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <section className="py-32 px-6 bg-navy text-center relative overflow-hidden">
                    ...
                    <FadeIn direction="up">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-md mx-auto">
                            <a href="#apply" className="group relative flex items-center justify-center overflow-hidden rounded-xl bg-primary px-10 h-16 text-white font-black transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-primary/40 w-full">
                                Apply Now
                            </a>
