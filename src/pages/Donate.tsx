        ...
        switch (step) {
                ...
                return (
                    ...
                    >
                        <div className="text-center">
                            <h3 className="text-3xl font-black text-navy mb-2 ">Select Amount</h3>
            ...
            case 2:
                return (
                    ...
                    >
                        <div className="text-center">
                            <h3 className="text-3xl font-black text-navy mb-2 ">Payment Method</h3>
                        ...
                        <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 space-y-6">
                            ...
                            {method === 'bank' ? (
                                <div className="space-y-4">
                                    ...
                                    <p className="text-xs text-slate-400 ">Please make the transfer and enter your transaction ref below (optional).</p>
                                </div>
                            ) : (
                                <div className="space-y-4">
                                    ...
                                    <p className="text-xs text-slate-400 ">You will receive a prompt on your phone to confirm the transaction.</p>
                                </div>
                            )}
                        </div>
                        <div className="flex gap-4">
            ...
            case 4:
                return (
                    ...
                    >
                        ...
                        <div>
                            <h3 className="text-4xl font-black text-navy mb-4 ">Thank You!</h3>
                        ...
                        <div className="lg:w-1/2 space-y-12">
                            ...
                            <FadeIn direction="right" delay={0.2}>
                                <h1 className="text-navy text-4xl md:text-6xl font-black leading-[0.9] tracking-tighter">
                                    Invest in the <br />
                                    <span className="text-primary ">Future</span> of Cameroon.
                                </h1>
                            </FadeIn>
