                ...
                <FadeIn direction="up">
                    ...
                    <form className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-6 py-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-none focus:ring-2 focus:ring-primary text-navy dark:text-white transition-all"
                                />
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <select className="w-full px-6 py-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-none focus:ring-2 focus:ring-primary text-navy dark:text-white transition-all appearance-none cursor-pointer">
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                className="w-full px-6 py-4 rounded-xl bg-slate-50 dark:bg-slate-800 border-none focus:ring-2 focus:ring-primary text-navy dark:text-white transition-all resize-none"
                            ></textarea>
                        </div>
