        ...
        >
            <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        className={`lg:hidden fixed top-6 right-6 w-14 h-14 flex items-center justify-center rounded-2xl transition-all active:scale-90 z-[100] shadow-2xl ${isScrolled || !isHome || isMobileMenuOpen
                            ? 'text-navy bg-white border border-slate-100'
            ...
            <AnimatePresence>
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 bg-navy/20 backdrop-blur-md z-[55]"
                ...
                <motion.div
                    ...
                    className="lg:hidden fixed right-0 top-0 bottom-0 w-[85%] max-w-md bg-white z-[60] p-8 flex flex-col pt-24 shadow-[-20px_0_60px_-15px_rgba(10,15,44,0.1)]"
                >
