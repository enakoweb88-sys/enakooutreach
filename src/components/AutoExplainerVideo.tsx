    ...
    return (
        <section className="relative w-full h-[70vh] min-h-[500px] overflow-hidden group">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-navy/60 backdrop-blur-[2px] transition-all duration-700 group-hover:bg-navy/40 group-hover:backdrop-blur-none" />
            </div>

            {/* Content Overlay */}
            <div className="relative z-10 h-full max-w-7xl mx-auto px-6 flex flex-col items-center justify-center text-center">
                <FadeIn direction="up">
                    <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 text-primary text-[10px] font-black uppercase tracking-[0.4em] mb-8 shadow-2xl">
                    ...
                    <h2 className="text-white text-5xl md:text-8xl font-black leading-[0.9] tracking-tighter mb-8 max-w-4xl">
                        A Legacy of <br />
                        <span className="text-primary italic">Hope Redefined.</span>
                    </h2>
                    ...
                    <button className="group relative flex items-center gap-4 px-12 py-5 bg-white rounded-2xl text-navy font-black text-xs uppercase tracking-[0.2em] hover:bg-primary hover:text-white transition-all duration-500 shadow-2xl">
                        <div className="w-10 h-10 rounded-full bg-navy/5 flex items-center justify-center group-hover:bg-white/20">
