                    ...
                    <div className="max-w-2xl">
                        <FadeIn direction="right">
                            ...
                            <h2 className="text-navy text-5xl md:text-7xl font-black tracking-tighter leading-none mb-4 ">
                                Insight & <span className="text-primary not-">Impact.</span>
                            </h2>
                        </FadeIn>
                        ...
                        <FadeIn key={post.id} direction="up" delay={i * 0.1} fullWidth>
                            <article className="group bg-white rounded-[3rem] overflow-hidden border border-slate-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-700 flex flex-col h-full">
                                ...
                                <div className="p-10 flex flex-col flex-grow">
                                    ...
                                    <h3 className="text-xl font-black text-navy leading-tight mb-4 group-hover:text-primary transition-colors ">
                                        {post.title}
                                    </h3>
